...
def generate_launch_description():
    ...
    # auto_serial_bridge: /cmd_vel -> serial -> lower controller
    ...
    # Add the actions to launch all navigation nodes
    ld.add_action(load_nodes)
    ld.add_action(load_composable_nodes)

    # Add serial bridge after Nav2 nodes
    ld.add_action(serial_bridge_launch)
